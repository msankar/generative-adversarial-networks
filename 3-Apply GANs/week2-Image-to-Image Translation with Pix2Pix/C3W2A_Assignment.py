...
def crop(image, new_shape):
    ...
    #print(image.shape)
    #print(new_shape)
    midHeight = image.shape[2] // 2
    midWidth = image.shape[3] // 2
    startHeight = midHeight - new_shape[2] // 2
    endHeight = startHeight + new_shape[2]
    startWidth = midWidth - new_shape[3] // 2
    endWidth = startWidth + new_shape[3]
    cropped_image = image[:, :, startHeight:endHeight, startWidth:endWidth]
