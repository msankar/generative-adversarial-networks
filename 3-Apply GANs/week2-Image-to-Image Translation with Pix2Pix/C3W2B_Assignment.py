...
def get_gen_loss(gen, disc, real, condition, adv_criterion, recon_criterion, lambda_recon):
    ...
    disc_fake = disc(fake_img, condition)
    gen_adv_loss = adv_criterion(disc_fake, torch.ones_like(disc_fake)) #adversarial loss
    gen_rec_loss = recon_criterion(real, fake_img) #reconstruction loss
